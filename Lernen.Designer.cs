namespace Vokabeltrainer
{
	partial class Lernen
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnEnd.Click += new System.EventHandler(this.btnSave_Click);
			// 
			// rbEngGer
			// 
			...
			this.btnAddVocabs.Click += new System.EventHandler(this.btnAddVocabs_Click);
			// 
			// btnReload
			// 
